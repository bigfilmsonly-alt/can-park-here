...
export function FleetScreen({ showToast }: FleetScreenProps) {
    ...
    return (
      <div className="flex flex-col min-h-[calc(100vh-5rem)] px-6 py-8 pb-28">
        <div className="text-center mb-8">
          ...
          <h1 className="text-[22px] font-bold tracking-tight text-foreground">Fleet Management</h1>
        ...
        <div className="space-y-4 mb-6">
          ...
          <div>
            <label className="text-[13px] font-semibold text-muted-foreground uppercase tracking-wider mb-3 block">
              Select Plan
            </label>
              ...
              {(["starter", "professional", "enterprise"] as const).map((plan) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full p-4 rounded-[22px] border text-left transition-colors ${
                      selectedPlan === plan
        ...
        <div className="mt-auto space-y-3">
          ...
          <Button
            ...
            variant="outline"
            className="w-full h-12 text-sm rounded-full bg-transparent"
          >
            Load Demo Data
          </Button>
        </div>
    ...
    return (
      <div className="flex flex-col min-h-[calc(100vh-5rem)] px-6 py-8 pb-28">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h1 className="text-[22px] font-bold tracking-tight text-foreground">Add Vehicle</h1>
        </div>
            ...
            <div className="grid grid-cols-4 gap-2">
              {(["car", "van", "truck", "motorcycle"] as const).map((type) => (
                <button
                  ...
                  className={`p-3 rounded-[16px] border text-center transition-colors ${
                    vehicleType === type
                      ? "border-primary bg-primary/5"
                      : "border-border bg-card"
                  }`}
    ...
    return (
      <div className="flex flex-col min-h-[calc(100vh-5rem)] px-6 py-8 pb-28">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h1 className="text-[22px] font-bold tracking-tight text-foreground">Add Driver</h1>
        </div>
      ...
      <div className="flex flex-col min-h-[calc(100vh-5rem)] px-6 py-8 pb-28">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-[22px] font-bold tracking-tight text-foreground">Vehicles</h1>
          </div>
        ...
        <div className="space-y-3 flex-1">
          {account?.vehicles.map((vehicle) => (
            <Card key={vehicle.id} className="p-4 rounded-[22px] card-elevated" style={{ boxShadow: "0 1px 2px rgba(0,0,0,.03), 0 1px 8px rgba(0,0,0,.02)" }}>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    {vehicle.parkingSession?.status === "active" && (
                      <div className="flex items-center gap-1.5 mt-1.5 text-xs" style={{ color: "var(--status-success)" }}>
        ...
        <Button
          ...
          className="w-full h-14 text-base font-medium rounded-full press-effect mt-4"
        >
      ...
      <div className="flex flex-col min-h-[calc(100vh-5rem)] px-6 py-8 pb-28">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-[22px] font-bold tracking-tight text-foreground">Drivers</h1>
          </div>
          <span className="text-[13px] font-semibold text-muted-foreground uppercase tracking-wider">
        ...
        <div className="space-y-3 flex-1">
          {account?.drivers.map((driver) => (
            <Card key={driver.id} className="p-4 rounded-[22px] card-elevated" style={{ boxShadow: "0 1px 2px rgba(0,0,0,.03), 0 1px 8px rgba(0,0,0,.02)" }}>
              <div className="flex items-start justify-between">
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 rounded-full bg-muted flex items-center justify-center">
  ...
  return (
    <div className="flex flex-col min-h-[calc(100vh-5rem)] px-6 py-8 pb-28">
      <div className="mb-6">
        <p className="text-[13px] font-semibold text-muted-foreground uppercase tracking-wider">Fleet Account</p>
        <h1 className="text-[22px] font-bold tracking-tight text-foreground mt-1">{account?.companyName}</h1>
      ...
      <div className="grid grid-cols-2 gap-3 mb-6">
        <Card className="p-4 rounded-[22px] card-elevated" style={{ boxShadow: "0 1px 2px rgba(0,0,0,.03), 0 1px 8px rgba(0,0,0,.02)" }}>
          <div className="flex items-center gap-2 text-muted-foreground mb-2">
            <Car className="h-4 w-4" />
            <span className="text-[11px] font-medium uppercase tracking-wider">Vehicles</span>
          </div>
          <p className="text-[28px] font-bold tracking-tight text-foreground">{stats?.totalVehicles || 0}</p>
        </Card>
        <Card className="p-4 rounded-[22px] card-elevated" style={{ boxShadow: "0 1px 2px rgba(0,0,0,.03), 0 1px 8px rgba(0,0,0,.02)" }}>
          <div className="flex items-center gap-2 text-muted-foreground mb-2">
            <MapPin className="h-4 w-4" />
            <span className="text-[11px] font-medium uppercase tracking-wider">Parked Now</span>
          </div>
          <p className="text-[28px] font-bold tracking-tight text-foreground">{stats?.activeParking || 0}</p>
        </Card>
        <Card className="p-4 rounded-[22px] card-elevated" style={{ boxShadow: "0 1px 2px rgba(0,0,0,.03), 0 1px 8px rgba(0,0,0,.02)" }}>
          <div className="flex items-center gap-2 mb-2" style={{ color: "var(--status-success)" }}>
            <CheckCircle className="h-4 w-4" />
            <span className="text-[11px] font-medium uppercase tracking-wider">Tickets Avoided</span>
          </div>
          <p className="text-[28px] font-bold tracking-tight text-foreground">{stats?.ticketsAvoided || 0}</p>
        </Card>
        <Card className="p-4 rounded-[22px] card-elevated" style={{ boxShadow: "0 1px 2px rgba(0,0,0,.03), 0 1px 8px rgba(0,0,0,.02)" }}>
          <div className="flex items-center gap-2 mb-2" style={{ color: "var(--status-success)" }}>
            <DollarSign className="h-4 w-4" />
            <span className="text-[11px] font-medium uppercase tracking-wider">Money Saved</span>
          </div>
      ...
      {stats && stats.expiringSoon > 0 && (
        <Card className="p-4 mb-4 rounded-[22px]" style={{ borderColor: "var(--status-warning)", backgroundColor: "color-mix(in srgb, var(--status-warning) 10%, transparent)" }}>
          <div className="flex items-center gap-3">
      ...
      {/* Quick actions */}
      <p className="text-[13px] font-semibold text-muted-foreground uppercase tracking-wider mb-3">Quick Actions</p>
