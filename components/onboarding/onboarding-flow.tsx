        ...
        <div className="flex items-center justify-center h-72">
          <div className="relative w-[240px] h-[240px]">
            {[
              ...
              <div
                key={i}
                className="absolute flex items-center gap-2.5 px-[22px] py-5 rounded-[20px] font-semibold text-xl"
                style={{
                  top: c.y,
                  left: c.x,
      ...
      vis: (
        <div className="px-9">
          ...
          >
            ...
            <div
              className="text-[11px] font-bold tracking-[0.1em] uppercase mt-6"
              style={{ color: "var(--park-accent)" }}
            >
              Ticket Guarantee
            </div>
            <div
              className="font-bold tracking-tight mt-1.5 leading-[1.05]"
            ...
            <div className="text-[13px] opacity-60 mt-3 leading-relaxed">
    ...
    <div
      ...
      style={{
        background: slide.isDark
          ...
          : "var(--park-bg)",
        color: slide.isDark ? "#fff" : "var(--park-fg)",
      }}
    >
      <div className="flex-1 flex flex-col justify-center pt-16">
        ...
        <div className="px-8 pt-10">
          <div
            className="count-reveal font-bold leading-[1.1]"
            style={{ fontSize: 28, letterSpacing: "-0.03em", textWrap: "balance" as never }}
          >
            {slide.title}
          </div>
          <div className="text-[15px] opacity-65 mt-3 leading-relaxed">{slide.sub}</div>
        </div>
      </div>
      ...
      <div className="px-6 pb-11">
        ...
        <button
          onClick={handleNext}
          className="hover-lift-interactive w-full py-4 rounded-full text-[15px] font-semibold press-effect"
          style={{
            background: slide.isDark ? "#fff" : "var(--park-fg)",
            color: slide.isDark ? "#1d4ed8" : "var(--park-bg)",
        ...
        {step > 0 && (
          <button
            onClick={onSkip}
            className="w-full mt-3 text-[13px] font-medium"
            style={{ color: slide.isDark ? "rgba(255,255,255,0.6)" : "var(--park-muted-fg)" }}
          >
            Skip
          </button>
        )}
