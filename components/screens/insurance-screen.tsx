...
export function InsuranceScreen({ showToast }: InsuranceScreenProps) {
    ...
    return (
      <div className="flex flex-col min-h-[calc(100vh-5rem)] px-6 py-8 pb-20">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-semibold text-foreground">Insurance Integration</h1>
        ...
        <Card className="p-5 mb-6 border-status-success bg-status-success/10">
          <div className="flex items-start gap-3">
  ...
  return (
    <div className="flex flex-col min-h-[calc(100vh-5rem)] px-6 py-8 pb-20">
      <div className="mb-6">
        <div className="flex items-center gap-2 text-sm text-status-success-foreground mb-1">
          <CheckCircle className="h-4 w-4" />
          <span>Connected to Insurance</span>
        </div>
      ...
      <div className="grid grid-cols-3 gap-3 mb-6">
        ...
        <Card className="p-3 text-center">
          <p className="text-2xl font-semibold text-status-success-foreground">0</p>
